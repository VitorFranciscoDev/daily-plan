...
class DailyPlanDatabase {
  ...
  ///
  /// The file is saved as `daily_plan.db` in the operating system's
  /// default databases directory.
  Future<Database> _initDatabase() async {
    final dbPath = await getDatabasesPath();
    final path = join(dbPath, 'daily_plan.db');
  ...
  Future<void> _onCreate(Database db, int version) async {
    await db.execute(TaskTable.createTaskTable());
  }
}